public class CDLinkedList {
	...
	public void swapRange(Iterator s1, Iterator f1, Iterator s2, Iterator f2) {
		...
		start1.currentNode.previousNode.nextNode = start2.currentNode;
		start2.currentNode.previousNode.nextNode = start1.currentNode;
		
		// point the start nodes to the new previous nodes
		DListNode previousTemp = start2.currentNode.previousNode;
		start2.currentNode.previousNode = start1.currentNode.previousNode;
		start1.currentNode.previousNode = previousTemp;
		
		// point the after end nodes to the new end nodes
		finish1.currentNode.nextNode.previousNode = finish2.currentNode;
		finish2.currentNode.nextNode.previousNode = finish1.currentNode;
		
		// point the end nodes to the new next nodes
		DListNode nextTemp = finish2.currentNode.nextNode;
		finish2.currentNode.nextNode = finish1.currentNode.nextNode;
		finish1.currentNode.nextNode = nextTemp;
	}
